...
class Exam_Emp extends CI_Controller {
    ...
    function __construct()
    {
	   ...
	   $this->load->model(array('emp/exam_Emp_model','emp/subject_model','emp/config_model','emp/answer_exam_model'));
...
//del_exam
	...
	{
		if($this->uri->segment(4) === FALSE){redirect('/emp/exam_emp', 'location');}
			else
			{
				...
				if($this->exam_model->delete_exam($examID))
				{
					...
					redirect('/emp/exam_emp', 'location');
				}
				else
				{
