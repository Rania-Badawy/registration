  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group">  <button class="btn btn-sm btn-default" data-role="next">&laquo; التالي</button><button class="btn btn-sm btn-default" data-role="prev"> السابق &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">توقف</button> </div> <button class="btn btn-sm btn-default" data-role="end">نهاية الجولة</button> </div> </div>',
