<?php
class Answer_Exam_Job_Model  extends CI_Model 
 {
///create_token
 ...
 //get_exams
	 public function get_exams($Lang)
	 {
		...
		$this->db->join('test', 'vw_test.test_ID =test.ID', 'INNER');	
  		$this->db->join('job_specializations', 'test.job_specializationsID =job_specializations.ID', 'INNER'); 
	...
	public function get_sum_degree($TestID)
	{
		...
		SELECT test_Degree AS SumDegreeQ 
		 FROM vw_test_emp_select WHERE test_ID = ".$TestID."
		");
