...
class Answer_New_Exam extends CI_Controller {
	private $data = array() ;
    ...
    function __construct()
    {
		...
		$this->load->model(array('emp/answer_exam_new_model','emp/subject_model','emp/exam_model','emp/config_model'));
	...
	public function index()
	{
				 ...
				 $this->load->emp_template('exam/answer_exam_list',$Data);
	}
//sees_answer
	public function sees_answer()
	{
		...
		if(isset($Data['exam_id'])&&$Data['exam_id']!=0 )
		{
			...
			redirect('/emp/answer_exam/show_exam', 'refresh');
		}
...
public function show_exam()
	{
		 $Data['exam_details'] = $this->answer_exam_new_model->get_exam_no_rpt((int)$this->uri->segment(4),(string) $this->data['Lang'] );
 		 $Data['q_details'] = $this->answer_exam_new_model->get_questions((int)$this->uri->segment(4),(string) $this->data['Lang'] ); 

		 $Data['q_answers'] = $this->answer_exam_new_model->get_answers((int)$this->uri->segment(4),(string) $this->data['Lang'] );
		 $this->load->emp_template('exam/answer_exam',$Data);
	}
//correction_exam
