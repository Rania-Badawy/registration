								...
								$.ajax({
										...
										success: function(data){
...

											{
												...
												$("#msg_images").html(data.msg_upload) ;
...
<div class="ask-st">
 ...
 <div class="sec-title">	
            ...
            <div class="form-group col-lg-6">
                ...
                <label class="control-label col-lg-12"><div class="error pull-left">*</div> <?php echo lang('question'); ?></label>

                <div class="col-lg-12 txt_question_st">
            ...
            <div class="col-lg-6">
               ...
               <div class="row">    
						...
						<div class="form-group col-lg-12 ">
							...
							<label class="control-label col-lg-3 padd_left_none"><div class="error">*</div>درجه صعوبة السؤال</label>
			...
			<?php /*?>                	 <select class="selectpicker form-control"  name="degree_difficulty" id="degree_difficulty">
						...
						<div class="form-group col-lg-12">
							...
							<label class="control-label col-lg-3"><div class="error">*</div> <?php echo lang('Degree'); ?></label>
