<?php
class Answer_Exam_New_Model  extends CI_Model 
 {
///create_token
 ...
 //get_exams
	 public function get_exams($Lang)
	 {
		...
		$this->db->join('test', 'vw_test.test_ID =test.ID', 'INNER');	
 ...
 //get_questions
	 public function get_questions($ExamID ,$Lang)
	 {
 ...
 //get_answers
	 public function get_answers($ExamID ,$Lang)
	 {
 ...
 //get_exam_no_rpt
	 public function get_exam_no_rpt($ExamID ,$Lang)
	 {
		
		$Data['ExamID'] = $ExamID  ;
					
		$this->db->select('test_ID,test_Name,test_Description,time_count,test_attach_file,questions_content_ID,Degree,Question,questions_types_ID,questions_types_Name,questions_types_Name_en');
		$this->db->from('vw_test_question_select');	
		$this->db->where('test_ID',$Data['ExamID']);
