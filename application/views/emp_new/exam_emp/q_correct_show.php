  ...
  <div class="col-lg-6">
             ...
             <?php
 			  foreach($item_question as $row){
                 ...
                 <button class="btn ask_btn  " style="display: inline-block!important;    background-color: #24ca40;
    border-color: #24ca40;
    color: #ffffff;" >
                 ...
                 <button class="btn    ask_btn" class="btn ask_btn  " style="display: inline-block!important;    background-color: #d93015 ;
    border-color: #d93015 ;
    color: #ffffff;">
