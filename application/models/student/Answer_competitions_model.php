<?php
class Answer_Competitions_Model  extends CI_Model 
 {
///create_token
 ...
 //get_exams
	 public function get_exams($Lang)
	 {
	    ...
	    $this->db->join('vw_competitions_select AS vw_test', 'vw_test.row_level_ID = student.R_L_ID', 'INNER');	
 ...
 // 
	...
	public function get_sum_degree($TestID)
	{
		...
		SELECT test_Degree AS SumDegreeQ 
		 FROM vw_competitions_select WHERE test_ID = ".$TestID."
		");
 ...
 //get_answer
	...
	//insert_s_degrees
	 ...
	 { 
		 ...
		 add_notification( $this->db->insert_id(),7,0,0,0 ,$idContact);
			      }else {
					$q_id_edit           = 	$id_q;	
					$ResultContactData = $ResultContactData ->result() ;
