...
$(document).ready( function () {
    ...
    function validation_upload(count_upload,row_num){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo  site_url('exam/add_upload_degree');?>",
					cache: false,
...
<a class="btn btn-success pull-left" href="<?php echo site_url('emp/exam_new/create_exam')?>" title="bottom left"><?php echo lang('Add_Exam'); ?> </a>
 ...
 <table id="example2" class="table table-striped table-bordered" cellspacing="0" width="100%">
     ...
     <tbody>
        ...
        <tr >
         ...
         <td  align="center"><?php  echo $subject_Name.' - للصف '.$row_Name.' - المرحلة '.$level_Name;?></td>
         <td  align="center"><?php  echo $Description;?></td>
         <td  align="center"><?php  echo $Name_sms;?></td>
         <td  align="center"><?php  echo $time_count;?></td>
         <td >
         <span class="tip" >
         <a class="btn btn-success btn-rounded" title="Edit" href="<?php echo site_url('emp/exam_new/set_exam_edit/'.$ID )?>" >
            <?php echo lang('edit'); ?> <i class="fa fa-edit"></i>
          </a>
       </span>
       </td>
         <td >
         <span class="tip" >
         <a class="btn btn-success btn-rounded" title="Edit" href="<?php echo site_url('emp/answer_exam/show_exam_new/'.$ID )?>" >
            <?php echo lang('edit'); ?> <i class="fa fa-edit"></i>
          </a>
       </span>
       </td> 
         ...
         <td >
         <span class="tip" >
         <a class="btn btn-success btn-rounded" title="Edit" href="<?php echo site_url('emp/exam_new/frame_exam/'.$ID  )?>" >
            <?php echo lang('edit'); ?> <i class="fa fa-edit"></i>
          </a>
       </span>
       </td> 
       <td> 
       <span class="tip" >
         <a class="btn btn-danger btn-rounded" id="1" class="Delete" href="<?php echo site_url('emp/exam/del_exam/'.$ID); ?>" onclick="return Del_Confirm(); " name="Band ring" title="Delete"  >
              <?php echo lang('delete'); ?> <i class="fa fa-trash-o"></i>
        </a>
      </span> 
     </td>
   </tr>
	...
	<tbody>
	   ...
	   $count_answers = 1;
            foreach($exams_students as $row){
				...
				$del_degree            = $this->exam_new_model->get_del_degree($test_ID);
				if($del_degree!=0){
				...
				$upload_answers        = $this->exam_new_model->get_upload_answers($test_ID,$student_ID);	
