...
///create_token
 ...
 //get_exams_students
	 ...
	 {
		$idContact = (int)$this->session->userdata('id'); 
		$this->db->select('vw_competitions_select.test_ID,vw_competitions_select.test_Name,vw_competitions_select.subject_Name,vw_competitions_select.contact_Name,vw_competitions_select.row_level_Name,vw_competitions_select.config_semester_Name,vw_competitions_select.test_Degree,contact.Name as student_name,contact.ID as student_ID,sum(test_student.Degree)as student_Degree');
		$this->db->from('config_emp');	
		$this->db->join('vw_competitions_select', 'vw_competitions_select.Subject_emp_ID =config_emp.ID', 'INNER');
		$this->db->join('test_questions', 'vw_competitions_select.test_ID =test_questions.Test_ID', 'INNER');
		...
		$this->db->where('vw_competitions_select.IsActive',1);
		$this->db->group_by('vw_competitions_select.test_ID,contact.ID');
		$ResultExam = $this->db->get();			
		$NumRowResultExam = $ResultExam->num_rows() ; 
 ...
 //get_exams_students_father
	 ...
	 {
		$idContact = (int)$this->session->userdata('id'); 
		$this->db->select('contact.Name as student_name,vw_competitions_select.test_ID,vw_competitions_select.test_Name,vw_competitions_select.subject_Name,vw_competitions_select.contact_Name,vw_competitions_select.row_level_Name,vw_competitions_select.config_semester_Name,vw_competitions_select.test_Degree,sum(test_student.Degree)as student_Degree');
		...
		$this->db->join('vw_competitions_select', 'vw_competitions_select.test_ID =test_questions.Test_ID', 'INNER');
		$this->db->where('student.Father_ID',$idContact);
		$this->db->group_by('vw_competitions_select.test_ID');
		$ResultExam = $this->db->get();			
		$NumRowResultExam = $ResultExam->num_rows() ; 
 ...
 //get_specific_exam
	 ...
	 {
		if($Lang=="english"){
		$this->db->select('test.date_from ,test.date_to ,test.ID AS test_ID,test.Name, test.Description  ,test.time_count ,test.ID,config_emp.SubjectID,subject.Name AS subject_Name , level.Name AS level_Name , row.Name AS row_Name,config_semester.Name_en AS Name_sms,config_semester.ID AS ID_sms');
		 }
		else
		 {	
		$this->db->select('test.date_from ,test.date_to ,test.ID AS test_ID,
 ...
 add_notification( $this->db->insert_id(),7,0,(int)$this->slct_subject,0 ,0);
