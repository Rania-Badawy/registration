(function(){
    ...
    //var API_KEY = '7GvrFLutSJq-noSFUyHFZg';
     var API_KEY = 'Jaoc_n9nSLyZNKgP1IGCgQ';
     ...
     */
    //var API_SECRET = 'B2Y4HxiI7fCm0ra2TRwtzJAfnsk6CJO3eSxH';
     var API_SECRET = 'IYBoRtKWxQBFsjM892xiulpHW0GucprD5Km8';
    ...
    document.getElementById('join_meeting').addEventListener('click', function(e){
        ...
        var meetConfig = {
            ...
            leaveUrl: "/index.php/student/zoom/listZoomMeeting",
        ...
        ZoomMtg.init({
            leaveUrl: "/index.php/father/zoom/listZoomMeeting1",
            success: function () {
                ZoomMtg.join(
                    {
                        meetingNumber: meetConfig.meetingNumber,
