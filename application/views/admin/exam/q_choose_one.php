...
<div class="clearfix"></div>                
                ...
                <div class="col-lg-1">
                  <div class="checkbox checkbox-success">
                     <input type="checkbox" onchange="chk_choose('<?php  echo $start_Choices?>');"   id="slct_Correct_Answer<?php  echo $start_Choices;?>" name="slct_Correct_Answer"   <?php if($start_Choices==1){?> checked="checked" value="1" <?php }else{?> value="0" <?php }?>/>
                     <label></label>
                  </div>
                </div>
                <div class=" col-lg-7">
                <input type="text" class="form-control"  name="txt_Choices<?php  echo $start_Choices;?>"   id="txt_Choices<?php  echo $start_Choices;?>"  >
                 </div>
