...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#btnAddExam").click(function (e) {
            ...
            var data = {
                ...
                Date_from: Date_from,
                txt_time: txt_time,
                slct_Semester: slct_Semester,
                slct_subject: slct_subject,
                txt_exam: txt_exam,
                ...
                success: function (html) {
                    if (html.stp == 0) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                add_exam_ID: add_exam_ID
                            },
                            cache: false,
                            success: function (html) {
                                $("#txt_exam_ID").val(add_exam_ID);
                                $('#showExam .block-st').html(html);
                                $('.btn-success').hide();
                                $('.btn-danger').hide();
                                $('#am_lis_exam').show();
                            }
    ...
    function add_question(q_type_id, q_name) {
        ...
        if ($('#showExam').css('display') == 'block' && $('#showExam .block-st').html() != "") {
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-lg-12">
                    <button type="button" data-dismiss="modal" id="btnAdddel"
                        class="btn btn-success pull-left"><?php echo lang('am_save');?></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="content margin-top-none container-page">
    ...
    <div class="block-st">
        ...
        <div class="sec-title">
            <h2>نموذج الاجابة </h2>
            <a class="btn btn-success pull-left" id="am_lis_exam" href="<?php echo site_url('emp/exam_new_emp/index'); ?>"><?php  echo lang('am_lis_exam');?></a>
            <div class="clearfix"></div>
        </div>
        <!-- // Block Title -->
                ...
                <?php 
                    if(isset($Type_question)){ 
                        foreach($Type_question as $row){
                            ...
                            ?>
                            <li>
                                <a onclick="add_question('<?php echo $Type_question_ID;?>','<?php echo $Type_question_Name;?>');" href="javascript:void(0)">
                        ...
                        <script>
                            ...
                            $.ajax({
                                ...
                                data: {
                                    txt_test_ID: txt_test_ID,
                                    q_type_id: q_type_id,
                                    questions_content_ID: questions_content_ID
                                },
                                cache: false,
                                success: function (html) {
