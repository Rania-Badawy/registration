...
<div class="sec-title">	
 ...
 <div class="clearfix"></div>                    
            ...
            <?php /*?><div class="form-group col-lg-6">
                <label class="control-label col-lg-3"><?php echo lang('Correct_Answer'); ?></label>
                <div id="Correct_Answer" class="col-lg-9">
                     <select class="selectpicker form-control" id="slct_Correct_Answer" name="slct_Correct_Answer" >
                        <?php 
						...
						?>
                     	 	<option value="<?php echo $Answer;?>" <?php if($CorrectAnswer == '1') echo"selected"; ?>>
                            	<?php echo $Answer ; ?>
                            </option>
						<?php		
                    	}
	 ...
	 <i class="fa fa-download"></i>  <?php echo lang('am_download');?>
     </a>
...
<div class="clearfix"></div>
            ...
            <div class="col-lg-9">          			
             <div class="error errorText"><?php echo form_error('slct_Correct_Answer') ?></div>
            </div>
         <?php
         }
        ?>                
