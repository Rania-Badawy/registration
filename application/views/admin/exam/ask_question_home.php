...
<table class="table table-bordered table-striped" id="static">
     <thead>
         <tr>
            ...
            <th width="174" ><?php echo lang('teacher_name'); ?></th>
            <th width="246" ><?php echo lang('Description'); ?></th>
            <th width="246" ><?php echo lang('Semester'); ?></th>
        ...
        <?php
            foreach($exam_details as $row){
				...
				$sumDegree            = $this->answer_exam_new_model->get_sum_degree($test_ID);	
				extract($sumDegree);
				$count++;
			?>
     <tbody>
        <tr>
         ...
         <td  align="center"><?php  echo  strip_tags( $test_Description);?></td>
...
?>
<a href="<?php echo site_url('emp/exam_new/frame_exam/'.$test_ID )?>"  >نموذج الاجابة</a>
<?php
